...
public class MainActivity extends AppCompatActivity {
    ...
    //All data array
    public static String[] all_data_array = new String[13];
    ...
    public static void setDataArray() {
        ...
        all_data_array[2] = startingLevel;
        all_data_array[3] = autoScore1Text;
        all_data_array[4] = autoScore2Text;
        all_data_array[5] = teleScore1Text;
        all_data_array[6] = teleScore2Text;
        all_data_array[7] = teleScore3Text;
        all_data_array[8] = teleScore4Text;
        all_data_array[9] = endLevel;
        all_data_array[10] = finalScore;
        all_data_array[11] = comments;
    }
}
